...
CREATE TABLE `categories_liked` (
  ...
  KEY `IX_categories_liked_CategoryId` (`CategoryId`),
  CONSTRAINT `FK_categories_liked_TrackCategories_CategoryId` FOREIGN KEY (`CategoryId`) REFERENCES `trackcategories` (`Id`) ON DELETE CASCADE,
...
INSERT INTO `categories_liked` VALUES (2,7,0),(2,18,0),(2,25,0),(3,1,0),(3,7,0),(3,8,0),(3,12,0),(3,25,0);
...
-- Dump completed on 2024-12-13 14:46:26
