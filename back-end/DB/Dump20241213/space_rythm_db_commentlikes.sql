...
CREATE TABLE `commentlikes` (
  ...
  UNIQUE KEY `IX_CommentLikes_UserId_CommentId` (`UserId`,`CommentId`),
  KEY `IX_CommentLikes_CommentId` (`CommentId`),
  CONSTRAINT `FK_CommentLikes_Comments_CommentId` FOREIGN KEY (`CommentId`) REFERENCES `comments` (`CommentId`) ON DELETE CASCADE,
  CONSTRAINT `FK_CommentLikes_Users_UserId` FOREIGN KEY (`UserId`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
